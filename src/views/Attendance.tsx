    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col col-span-1 md:col-span-3 h-[calc(100vh-10rem)]">
          <div className="p-5 border-b border-slate-100 flex justify-between mục-center bg-white">
            <div>
          ...
          <div className="border-b border-slate-100 bg-slate-50/70 px-5 py-4">
            ...
            <div className="mt-3 flex flex-wrap mục-center justify-between gap-2 text-xs text-slate-500">
                  ...
                  {paginatedRequests.items.map(request => (
                    <tr key={request.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex mục-center px-2 py-1 rounded text-[10px] font-bold uppercase ${getAdjustmentStatusClasses(request.status)}`}
                        >
                          {request.status}
                        </span>
                      </td>
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          className="text-blue-600 hover:text-blue-800 transition-colors inline-flex mục-center text-xs font-medium"
                        >
                          Chi tiết
                        </button>
                      </td>
                      ...
                      <tr key={record.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="space-y-1">
                            <span
                              className={`inline-flex mục-center px-2 py-1 rounded text-[10px] font-bold uppercase ${getStatusBadgeClasses(record.status)}`}
                            >
                              {record.status === 'VALID' ? (
          ...
          <div className="border-t border-slate-100 bg-white px-5 py-4">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex mục-center gap-2 text-sm text-slate-500">
